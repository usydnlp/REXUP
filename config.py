...
class Config(object):
    ...
    sceneDictFilename = "sceneVocab.pkl"
    ...
    sceneGraphsFile = lambda self, tier: self.dataFile(self.sceneGraphsFilename.format(tier=tier))
    ...
    sceneDictFile = lambda self: self.generatedFile(self.sceneDictFilename)
...
def parseArgs():
    ...
    # tensorboard
    parser.add_argument("--tensorboardDir", default="./logs", type=str)
    parser.add_argument("--tensorboardGraph", default=False, type=bool)

    # experiment files
    parser.add_argument("--expName", default="experiment", type=str, help="experiment name")

    # data files
    parser.add_argument("--dataset", default="GQA", type=str)
    ...
    parser.add_argument("--imageObjectsAndGrid", action="store_true")
    parser.add_argument("--imageSceneGraph", action="store_true")
    parser.add_argument("--imageObjectsAn", action="store_true")
    parser.add_argument("--imageEnsembleFeatures", action="store_true")
    # parser.add_argument("--imageEnsembleChoices", default=["spatial", "object", "scene"], type=str)  # [14, 14, 2048]
    parser.add_argument("--imageEnsembleChoices", default=["object", "scene"], type=str)  # [14, 14, 2048]
...
def configGQA():
    config.dataPath = "{dataBasedir}/data/gqa".format(dataBasedir=config.dataBasedir)
    ...
    config.sceneGraphsFilename = "sceneGraphs/{tier}_sceneGraphs.json"
